...
public class ListAdapter extends BaseAdapter {
    ...
    public ListAdapter(Context mContext, ArrayList<ListItem> mListItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = mInflater.inflate(R.layout.personal_list_item, null);
            ...
            holder.item_view_left = (ImageView) convertView.findViewById(R.id.item_view_left);
        ...
        holder.item_view_left.setImageResource(item.getItemViewLeftId());
    ...
    public final class ViewHolder {
        ...
        public ImageView item_view_left;
